...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: [
			"assets/images/DesktopWallpaper/l1.avif",
			
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: [
			"assets/images/MobileWallpaper/n1.avif",
	...
	common: {
		...
		homeText: {
			...
			enable: true,
			// 主页横幅主标题
			title: "Lovely LuoTianyi!",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"First Vocaloid Singer in China !",
				"Enjoy your stay !",
			...
			links: [
				...
				},
				{
					...
					url: "https://space.bilibili.com/37880274",
				},
				{
					name: "RSS",
					icon: "fa7-solid:rss",
