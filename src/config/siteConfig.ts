...
export const siteConfig: SiteConfig = {
	...
	title: "Lonako",
	// 站点副标题
	subtitle: "A personal blog about technology, anime, and more.",

	// 站点 URL
	site_url: "https://lonako-blog.bocchi0708.workers.dev",

	// 站点描述
	description:
		"博客模板来自于Github开源项目Firefly,一款基于 Astro 框架和 Fuwari 模板开发的清新美观且现代化个人博客主题模板，专为技术爱好者和内容创作者设计。",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/luotianyi.png",
			alt: "✨",
		},
		// 导航栏标题
		title: "Lonako",
